              ...
              {dataGoal ? (
                <div className="min-w-[260px] rounded-xl border border-border/60 bg-muted/20 px-5 py-4 transition-colors">
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    {goalScopeLabel ? (
                      <span className="rounded-full border border-secondary/40 bg-secondary/20 px-2 py-0.5 text-[0.6rem] font-semibold uppercase tracking-[0.2em] text-secondary-foreground">
                        {goalScopeLabel}
                      </span>
                    ) : null}
                  </div>
