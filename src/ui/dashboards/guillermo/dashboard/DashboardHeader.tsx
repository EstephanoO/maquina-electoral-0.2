...
import { formatNumber } from "@/dashboards/guillermo/utils/dashboardFormat";
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className="rounded-2xl bg-card/70 px-4 py-3 shadow-sm ring-0">
              ...
              <div className="mt-2 h-2 rounded-full bg-muted/60">
                <div
                  className="h-2 rounded-full bg-gradient-to-r from-[#163960] to-[#2b4f86]"
            ...
            <div className="rounded-2xl bg-card/70 px-4 py-3 shadow-sm ring-0">
              ...
              <div className="mt-2 h-2 rounded-full bg-muted/60">
                <div
                  className="h-2 rounded-full bg-gradient-to-r from-[#163960] to-[#ffc800]"
                  style={{ width: `${Math.min(progress, 100)}%` }}
                />
              </div>
            </div>
            <div className="rounded-2xl bg-card/70 px-4 py-3 shadow-sm ring-0">
              ...
              <div className="mt-2 h-2 rounded-full bg-muted/60">
                <div
                  className="h-2 rounded-full bg-gradient-to-r from-[#2b4f86] to-[#ffc800]"
                  style={{ width: `${Math.min(progress, 100)}%` }}
                />
              </div>
            </div>
