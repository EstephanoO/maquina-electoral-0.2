...
import { useDailySeries } from "@/dashboards/guillermo/hooks/useDailySeries";
import { useDashboardTheme } from "@/dashboards/guillermo/hooks/useDashboardTheme";
import { useLandingsPayments } from "@/dashboards/guillermo/hooks/useLandingsPayments";
import { usePanoramaData } from "@/dashboards/guillermo/hooks/usePanoramaData";
import type {
  DailyPoint,
  GrowthSeriesItem,
  PanoramaPageChart,
  SentimentStackDatum,
  SummaryCard,
} from "@/dashboards/guillermo/types/dashboard";
import { truncateText } from "@/dashboards/guillermo/utils/dashboardFormat";
import {
  calculateAverageReach,
  calculateTrendSeries,
} from "@/dashboards/guillermo/utils/dashboardMath";
